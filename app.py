...
st.header("Application Match System")
...
uploaded_file2=st.file_uploader("Upload your third resume(PDF)...",type=["pdf"])
...
if submit3:
    if uploaded_file is not None:
        ...
        st.subheader("The Repsonse for first uploaded resume")
        st.write(response)
    else:
        st.write("Please uplaod the resume")
